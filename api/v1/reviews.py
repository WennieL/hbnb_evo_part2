...
@reviews_routes.route('/places/<place_id>/reviews', methods=['GET'])
...
@reviews_routes.route('/users/<user_id>/reviews', methods=['GET'])
...
@reviews_routes.route('/reviews/<review_id>', methods=['GET'])
...
@reviews_routes.route('/places/<place_id>/reviews', methods=["POST"])
...
@reviews_routes.route('/reviews/<place_id>', methods=["PUT"])
...
@reviews_routes.route('/reviews/<review_id>', methods=["DELETE"])
